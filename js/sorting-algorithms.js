  ...
  update(){
    ...
    if (Math.round(this.x) < Math.round(this.go)) {
      ...
      if (this.img.src == "https://alangomezpasillas.github.io/img/sorting-algorithms/cube.png") {
        this.y = -Math.cbrt((Math.sin((Math.PI*this.sizex)*(this.x+1))/this.tdis)*64000)+242;
      }
    } else if(Math.round(this.x) > Math.round(this.go)) {
      this.x -= velocity;
      if (this.img.src == "https://alangomezpasillas.github.io/img/sorting-algorithms/cube.png") {
        this.y = Math.cbrt((Math.sin((Math.PI*this.sizex*0.8)*(this.x+1))/this.tdis)*64000)+170;
      }
    } else {
